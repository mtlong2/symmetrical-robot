...
print('Logistic Regression classification report :',classification_report(y_val,lr_yhat_val)) 
print('Logistic Regression accuracy - Validation Set:',accuracy_score(y_val, lr_yhat_val))
...
bayes_model.fit(X_train_seq, y_train)
bayes_score = bayes_model.score(X_val_seq, y_val)
bayes_yhat_val = bayes_model.predict(X_val_seq)
...
plt.xlabel('true label')
plt.ylabel('predicted label')
print('Naive Bayes classification report :',classification_report(y_val,bayes_yhat_val)) 
print('Naive Bayes accuracy - Validation Set:',accuracy_score(y_val, bayes_yhat_val))
...
plt.xlabel('true label')
plt.ylabel('predicted label')
print('Random Forest classification report :',classification_report(y_val,RF_norm_pred))  
...
plt.xlabel('true label')
plt.ylabel('predicted label')
print('Gradient Boosting classification report :',classification_report(y_val,grad_pred))  
...
estimator = KerasClassifier(build_fn=baseline_model, epochs=2, batch_size=128, verbose=0)
...
print('Feed Forward network classification score')
...
model.add(Bidirectional(LSTM(512, dropout=0.5, activation='relu', return_sequences=True)))
...
Print('LSTM accuracy Test Set :',lstm_accuracy(y_orig,y_hat))
